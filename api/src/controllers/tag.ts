...
import respository from '../repositories/tag';
...
const create = async (req: Request, res: Response) => {
    try {
        ...
        res.status(201);
        return res.json({ data: result, message: "Tag created successfully" })
    } catch (err) {
        return transformError(err, res);
    }
}
...
const update = async (req: Request, res: Response) => {
    try {
        ...
        res.status(200);
        return res.json({ data: result, message: "Tag updated successfully" })
    } catch (err) {
        return transformError(err, res);
    }
}
...
const destroy = async (req: Request, res: Response) => {
    try {
        ...
        res.status(202);
        return res.json({ data: result, message: "Tag Deleted successfully" })
    } catch (err) {
        return transformError(err, res);
    }
