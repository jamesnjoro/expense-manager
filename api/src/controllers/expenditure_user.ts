...
import respository from '../repositories/expenditure_user';
...
const create = async (req: Request, res: Response) => {
    try {
        ...
        res.status(201);
        return res.json({ data: result, message: "User access granted successfully" })
    } catch (err) {
        return transformError(err, res);
    }
}
...
const update = async (req: Request, res: Response) => {
    try {
        ...
        res.status(200);
        return res.json({ data: result, message: "User access updated successfully" })
    } catch (err) {
        return transformError(err, res);
    }
}
...
const destroy = async (req: Request, res: Response) => {
    try {
        ...
        res.status(202);
        return res.json({ data: result, message: "User access Deleted successfully" })
    } catch (err) {
        return transformError(err, res);
    }
